...
namespace DotnetSkeleton.IdentityModule.Domain.Interfaces.Services
{
    public interface IAuthService
    {
        ...
        /// </summary>
        /// <param name="forgotPasswordRequest">An instance of the <see cref="ForgotPasswordRequest"/> class containing the user's email address for initiating the password reset process.</param>
