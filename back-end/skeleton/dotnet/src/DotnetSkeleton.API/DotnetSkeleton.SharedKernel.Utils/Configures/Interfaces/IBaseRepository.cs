...
namespace DotnetSkeleton.SharedKernel.Utils.Configures.Interfaces;
...
public interface IBaseRepository<TDbContext, TEntity, in TKey>
    ...
    where TEntity : class
{
    ...
    Task<List<TEntity>> FindAllWithPaginationAsync(int pageNumber, int pageSize);
