...
namespace DotnetSkeleton.UserModule.Domain.Interfaces.Services
{
    ...
    {
        /// <summary>
        /// Retrieves all users with MySQL
        /// </summary>
        /// <returns>A task that represents the asynchronous operation. The task result contains the response with all users.</returns>
        Task<BaseResponse> GetAllUsersWithMySQLAsync();
